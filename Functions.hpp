...
void printPrompt(string prompt, string label="info!", bool pause=true, bool clear=true,int width=0);

void centerText(string input, char fill='*', char edge=' ',int padding=1,int width=75);
